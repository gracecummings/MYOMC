...
if [ "$QUEUE" == "condor" ]; then
    ...
    mkdir testrun_rhad
    cd testrun_rhad
    source "$STARTDIR/../campaigns/RunIISummer20UL18GEN/run.sh" test_rhad "$STARTDIR/EXO-RunIISummer20UL18GENSIM_gluino_fragment.py" 2 3 1 "$STARTDIR/../campaigns/RunIISummer20UL18GEN/pileupinput.dat" "1600"
